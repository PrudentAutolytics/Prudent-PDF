...
check(js.includes("frameNo%5===0"),'video face regions are refreshed repeatedly during export');
check(js.includes("Number($('facePadding')?.value || 18) / 100"),'face masks apply configurable safety padding');
